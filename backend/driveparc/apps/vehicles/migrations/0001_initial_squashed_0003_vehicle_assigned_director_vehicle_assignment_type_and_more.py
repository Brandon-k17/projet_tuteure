...
class Migration(migrations.Migration):
    ...
    replaces = [('vehicles', '0001_initial'), ('vehicles', '0002_vehicle_category'), ('vehicles', '0003_vehicle_assigned_director_vehicle_assignment_type_and_more')]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('TOURISME', 'Tourisme'), ('UTILITAIRE', 'Utilitaire'), ('BUS', 'Bus')], default='TOURISME', help_text='TOURISME=<10 places, UTILITAIRE=10-19 places, BUS=20+ places', max_length=20, verbose_name='Catégorie')),
                ('assigned_director', models.CharField(blank=True, default='', max_length=150, verbose_name='Directeur assigné')),
                ('assignment_type', models.CharField(choices=[('POOL', 'Parc commun'), ('FONCTION', 'Voiture de fonction'), ('BUS_SCOLAIRE', 'Bus scolaire')], default='POOL', max_length=20, verbose_name="Type d'affectation")),
                ('bus_driver', models.ForeignKey(blank=True, help_text='Uniquement pour les bus scolaires — ramassage matin', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='bus_assignments', to=settings.AUTH_USER_MODEL, verbose_name='Chauffeur bus assigné')),
            ],
            options={
