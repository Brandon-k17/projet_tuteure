    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_budget', models.DecimalField(decimal_places=2, max_digits=15, validators=[django.core.validators.MinValueValidator(0)], verbose_name='Budget total (XAF)')),
                ...
                ('approved_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='budgets_approved', to=settings.AUTH_USER_MODEL, verbose_name='Approuvé par')),
            ],
            options={
                'verbose_name': 'Budget',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expense_type', models.CharField(choices=[('CARBURANT', 'Carburant'), ('MAINTENANCE', 'Maintenance'), ('REPARATION', 'Réparation'), ('ASSURANCE', 'Assurance'), ('TAXES', 'Taxes'), ('PIECES', 'Pièces détachées'), ('AUTRES', 'Autres')], max_length=20, verbose_name='Type de dépense')),
                ('title', models.CharField(max_length=200, verbose_name='Titre')),
                ('description', models.TextField(verbose_name='Description')),
                ('amount', models.DecimalField(decimal_places=2, max_digits=12, validators=[django.core.validators.MinValueValidator(0)], verbose_name='Montant (XAF)')),
                ...
                ('payment_method', models.CharField(blank=True, choices=[('ESPECES', 'Espèces'), ('CHEQUE', 'Chèque'), ('VIREMENT', 'Virement bancaire'), ('CARTE', 'Carte bancaire'), ('CREDIT', 'À crédit')], max_length=50, null=True, verbose_name='Méthode de paiement')),
                ('approval_date', models.DateField(blank=True, null=True, verbose_name="Date d'approbation")),
