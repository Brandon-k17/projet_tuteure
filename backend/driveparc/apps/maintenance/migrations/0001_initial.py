    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('maintenance_type', models.CharField(choices=[('PREVENTIVE', 'Préventive'), ('CORRECTIVE', 'Corrective'), ('PERIODIQUE', 'Périodique')], max_length=20, verbose_name='Type de maintenance')),
                ...
                ('technician', models.ForeignKey(blank=True, limit_choices_to={'role': 'TECHNICIEN'}, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='maintenances_performed', to=settings.AUTH_USER_MODEL, verbose_name='Technicien')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('severity', models.CharField(choices=[('FAIBLE', 'Faible'), ('MOYENNE', 'Moyenne'), ('ELEVEE', 'Élevée'), ('CRITIQUE', 'Critique')], default='MOYENNE', max_length=20, verbose_name='Gravité')),
                ('status', models.CharField(choices=[('SIGNALE', 'Signalé'), ('EN_DIAGNOSTIC', 'En diagnostic'), ('EN_REPARATION', 'En réparation'), ('REPARE', 'Réparé'), ('NON_REPARABLE', 'Non réparable')], default='SIGNALE', max_length=20, verbose_name='Statut')),
                ...
                ('notes', models.TextField(blank=True, null=True, verbose_name='Notes')),
                ('assigned_technician', models.ForeignKey(blank=True, limit_choices_to={'role': 'TECHNICIEN'}, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='breakdowns_assigned', to=settings.AUTH_USER_MODEL, verbose_name='Technicien assigné')),
                ...
                ('maintenance', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='related_breakdowns', to='maintenance.maintenance', verbose_name='Maintenance associée')),
            ],
            options={
                'verbose_name': 'Panne',
        ...
        migrations.AddIndex(
            model_name='maintenance',
            index=models.Index(fields=['maintenance_type'], name='maintenance_mainten_95f943_idx'),
        ),
        migrations.AddIndex(
            model_name='breakdown',
            index=models.Index(fields=['vehicle', 'status'], name='maintenance_vehicle_83a3ab_idx'),
        ),
        migrations.AddIndex(
            model_name='breakdown',
            index=models.Index(fields=['severity'], name='maintenance_severit_b47cf1_idx'),
        ),
        migrations.AddIndex(
            model_name='breakdown',
            index=models.Index(fields=['reported_date'], name='maintenance_reporte_6e290e_idx'),
        ),
    ]
